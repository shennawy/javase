...
CREATE TABLE OE.ORDER_ITEMS (ORDER_ITEM_ID number(6, 0) NOT NULL, ORDER_ITEM_QTY number(6, 0), ORDER_ID number(6, 0) NOT NULL, PRODUCT_ID number(6, 0) NOT NULL, PRIMARY KEY (ORDER_ITEM_ID));
