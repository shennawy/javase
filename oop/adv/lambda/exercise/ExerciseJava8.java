...
public class ExerciseJava8 {
    ...
    public static void main(String[] args) {
     ...
     System.out.println("After .sort");
        ...
        printPersonsConditional(personsList, p -> p.getPersonFirstName().startsWith("A"), p -> System.out.println(p.getPersonFirstName()));
      

   
        System.out.println("*****Last Name A*****");
        // Lambda
        printPersonsConditional(personsList, p -> p.getPersonLastName().startsWith("A"),p->System.out.println(p.getPersonLastName()));
        //System.out.println("*****All list*****");
